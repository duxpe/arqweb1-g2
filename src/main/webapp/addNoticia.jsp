...
<head>
    ...
    <title>Adicionar Notícia - G2 Notícias</title>
...
<body>
        ...
        <form action="criar-noticia" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid-feedback">Por favor, insira o título da notícia.</div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid-feedback">Por favor, insira a data de publicação.</div>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="categoria" class="form-label">Categoria</label>
                    <select class="form-control" id="categoria" name="categoria" required>
                        <option value="">Selecione uma categoria</option> <option value="Política">Política</option>
            ...
            <div class="mb-3">
                ...
                <div class="invalid-feedback">Por favor, insira um resumo para a notícia (máximo 300 caracteres).</div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="invalid-feedback">Por favor, insira o conteúdo completo da notícia.</div>
            </div>

            <div class="mb-3">
                <label for="imagem" class="form-label">Imagem de Destaque</label>
                <input type="file" class="form-control" id="imagem" name="imagem" accept="image/*">
                <div class="form-text">Opcional. Tamanho máximo recomendado: 500KB.</div>
            </div>
    ...
    <script src="assets/js/components.js" defer></script> 
    <script src="assets/js/addNews.js" defer></script> 
</body>
</html>