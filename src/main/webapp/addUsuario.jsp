...
<div class="container py-5">
	...
	<form action="${pageContext.request.contextPath}/criar-usuario"
		...
		<div class="mb-3">
			<label for="usuario" class="form-label">Usuário (login)</label> <input
		...
		<div class="mb-3">
			<label for="idade" class="form-label">Idade</label> <input
				type="number" class="form-control" id="idade" name="idade" min="0"
				max="150" required>
		</div>
